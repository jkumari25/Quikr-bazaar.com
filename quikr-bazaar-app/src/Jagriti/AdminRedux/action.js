...
import { useToast } from "@chakra-ui/react";
 ...
 const loginSuccess = () => {
  ...
  let details;
  export const loginadmin=(adminemail ,adminpassword,toast, setadminpassword ,setAdminEmail )=>(dispatch)=>{
    // const toast = useToast()
    dispatch(loginRequest())
    return axios.get(`https://pear-gleaming-squid.cyclic.app/Adminlogin?adminemail=${adminemail}`)
    .then((res)=>{
        console.log(res);
