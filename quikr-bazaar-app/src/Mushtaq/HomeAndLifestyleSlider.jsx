...
import { Box, Button, Flex, Heading, Img, Link, SimpleGrid, Spacer, Text } from '@chakra-ui/react';
...
export const HomeAndLifestyleSlider = () => {
  return (
      <Box className={styles["list-products"]} style={{width:"80%",margin:"auto"}}>
          <Box>
          <Flex>
              <Box className={styles.heading}><Text style={{fontSize:"18px" , fontWeight:"600"}}>Home & Lifestyle</Text></Box>    
              <Spacer/>        
